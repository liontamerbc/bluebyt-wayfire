...
log "Installing Aretha-Dark-Icons from gnome-look.org..."
curl -fL "https://www.gnome-look.org/p/2180417/download" -o Aretha-Dark-Icons.tar.gz 2>>"$LOG_FILE" || { log "Failed to download Aretha-Dark-Icons."; FAILED=true; cleanup; }
